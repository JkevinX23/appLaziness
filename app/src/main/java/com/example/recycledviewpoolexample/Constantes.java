...
public class Constantes {
    ...
    public static final String nome_usuario_tabela_usuario = "NOME";
    public static final String senha_usuario_tabela_usuario = "SENHA";
    public static final String idade_tabela_usuario = "IDADE";
    public static final String curso_tabela_usuario = "CURSO";
    public static final String sexo_tabela_usuario = "SEXO";
    public static final int versao_tabela_usuario = 1;
